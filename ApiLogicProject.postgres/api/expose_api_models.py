...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.CustomerCustomerDemo, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.UsState, method_decorators= method_decorators)
    return api
