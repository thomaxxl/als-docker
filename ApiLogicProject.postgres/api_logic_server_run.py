...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 09.01.11, July 23, 2023 08:23:34):
...
app_logger.info(f'Created July 23, 2023 08:23:34 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 09.01.11\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 09.01.11\n'
    if is_docker():
